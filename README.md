...
> **Note:** This repository is a fork of [ZJU-FAST-Lab/Swarm-Formation](https://github.com/ZJU-FAST-Lab/Swarm-Formation).
> It adds a CBF (control barrier function) based obstacle-avoidance / replan-trigger layer, FSM state handling changes, and Docker/Makefile build helpers on top of the original framework.
> All credit for the original work goes to the FAST-Lab authors; this fork is released under the same [GPLv3](https://www.gnu.org/licenses/) license — see [`LICENSE`](LICENSE).
